...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="rounded-md pt-5 bg-black align-middle text-center xs:text-md sm:text-lg md:text-xl lg:text-3xl xl:text-4xl bold tracking-wide text-gray-100 ">
        Welcome!
      </div>
      ...
      <div className="flex flex-col flex-wrap content-center max-w-full overflow-hidden h-full pb-40 pl-10 pr-10">
