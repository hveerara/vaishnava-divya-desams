  ...
  return (
    <>
      ...
      <div className="h-full w-full flex flex-col">
        ...
        <div className="rounded-md p-5 bg-black align-middle text-center xs:text-sm sm:text-md md:text-lg lg:text-xl xl:text-2xl bold tracking-wide text-gray-100 ">
                  ...
                  >
                    <div className="flex h-full items-center justify-center">
                      <div className="text-white">
                        <h1 className="text-center xs:text-md sm:text-lg md:text-xl lg:text-2xl xl:text-3xl bold tracking-wide text-white ">
                          {category}
                        </h1>
                      </div>
                    </div>
